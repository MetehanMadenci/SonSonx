...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    {
        public SliderScaleController sliderController; // Inspector'dan atanacak

        [SerializeField]
        [Tooltip("The camera that objects will face when spawned. If not set, defaults to the main camera.")]
        Camera m_CameraToFace;
        // Class body i�ine ekle
        private bool hasSpawned = false;
        private GameObject spawnedObject;

        /// <summary>
        /// Spawn i�lemini s�f�rlamak i�in kullan�l�r.
        /// </summary>
        /// 
        ...
        public bool TrySpawnObject(Vector3 spawnPoint, Vector3 spawnNormal)
        {
            ...
            spawnedObject.transform.rotation = Quaternion.LookRotation(projectedForward, spawnNormal);
            ...
            if (m_SpawnVisualizationPrefab != null)
            {
                ...
                visualizationTrans.rotation = spawnedObject.transform.rotation;
            }

            hasSpawned = true;

            if (sliderController != null)
                sliderController.SetTargetModel(spawnedObject);
